...
import { SYMBOLIC_BUILTIN_RE } from "@solve-js/packages/symbolic/SymbolicBuiltinIndex";

/**
 * `re(z)`, the real part of a complex value.
 *
 ...
 */
export class ReParselet implements PrefixParselet {
	...
	parse(parser: Parser, _token: Token, builder: BytecodeBuilder): void {
		...
		builder.emitIndex(SYMBOLIC_BUILTIN_RE);
		builder.emitIndex(1);
	}
}
