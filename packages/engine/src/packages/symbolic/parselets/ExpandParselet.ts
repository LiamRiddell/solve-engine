...
import { SYMBOLIC_BUILTIN_EXPAND } from "@solve-js/packages/symbolic/SymbolicBuiltinIndex";

/**
 * `expand(expr)`, multiplying out every product and power.
 *
 ...
 */
export class ExpandParselet implements PrefixParselet {
	...
	parse(parser: Parser, _token: Token, builder: BytecodeBuilder): void {
		...
		builder.emitIndex(SYMBOLIC_BUILTIN_EXPAND);
		builder.emitIndex(1);
	}
}
