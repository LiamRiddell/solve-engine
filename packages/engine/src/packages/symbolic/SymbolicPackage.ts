...
export const SYMBOLIC_PACKAGE: IEnginePackage = {
	...
	prefixParselets: {
		EXPAND_FN: new ExpandParselet(),
		FACTOR_FN: new FactorParselet(),
		SOLVE_FN: new SolveParselet(),
		DER_FN: new DerParselet(),
		INTEGRAL_FN: new IntegralParselet(),
		TAYLOR_FN: new TaylorParselet(),
		JACOBIAN_FN: new JacobianParselet(),
		IMAGINARY: new ImaginaryParselet(),
		CONJ_FN: new ConjParselet(),
		RE_FN: new ReParselet(),
