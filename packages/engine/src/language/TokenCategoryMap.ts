...
const TOKEN_CATEGORY_MAP: Record<string, TokenCategory> = {
	...
	// The built-in packages' own fused tokens that had no category, so an editor
	// left them unstyled; found by `expectPackage(...).toBeWellFormed()` (#719).
	// A clock time, a clock interval and a lap time are moments and spans, as a
	// date literal and a duration are; a frame rate is a number; the rest are
	// phrase keywords, as `average of` and `time in` are.
	CLOCK_TIME: "datetime",
	CLOCK_TIME_INTERVAL: "datetime",
	LAPTIME: "datetime",
	FPS_RATE: "number",
	UNTIL_UNIT: "keyword",
	SINCE_UNIT: "keyword",
	WEEKDAY_BETWEEN: "keyword",
	WEEKDAY_UNTIL: "keyword",
	WEEKDAY_SINCE: "keyword",
	DATE_OFFSET_AFTER: "keyword",
	DATE_OFFSET_BEFORE: "keyword",
	FROM_ENCODING: "keyword",
	SECTION_SUM: "keyword",
	SECTION_AVERAGE: "keyword",
	SECTION_COUNT: "keyword",
	STANDARD_DEVIATION_OF: "keyword",
	SAMPLE_STANDARD_DEVIATION_OF: "keyword",
	VARIANCE_OF: "keyword",
	SAMPLE_VARIANCE_OF: "keyword",
	SPREAD_OF: "keyword",
	MODE_OF: "keyword",
	WEIGHTED_AVERAGE_OF: "keyword",
	TABLE_COLUMN_SUM: "keyword",
	TABLE_COLUMN_AVERAGE: "keyword",
	TABLE_COLUMN_MIN: "keyword",
	TABLE_COLUMN_MAX: "keyword",
	TABLE_COLUMN_COUNT: "keyword",
	TABLE_COLUMN_MEDIAN: "keyword",
	TABLE_COLUMN_STDEV: "keyword",
	TABLE_COLUMN_SAMPLE_STDEV: "keyword",
	TABLE_COLUMN_VARIANCE: "keyword",
	TABLE_COLUMN_SAMPLE_VARIANCE: "keyword",
	TABLE_COLUMN_SPREAD: "keyword",
	TABLE_COLUMN_MODE: "keyword",
	TAG_SUM: "keyword",
	TAG_AVERAGE: "keyword",
	TAG_COUNT: "keyword",
	TAG_BREAKDOWN: "keyword",
	UOM_POSSIBILITIES_QUERY: "keyword",
	WEATHER_IN: "keyword",
	TEMPERATURE_IN: "keyword",
	FEELS_LIKE_IN: "keyword",
	HIGH_IN: "keyword",
	LOW_IN: "keyword",
