...
import type { MatrixData, RangeData, ColourData } from "@solve-js/vm/Value";
...
export interface VmStepEvent extends BaseEvent {
  ...
  readonly stack: ReadonlyArray<{
    ...
    readonly value: number | bigint | string | boolean | MatrixData | RangeData | ColourData | SymbolicNode;
