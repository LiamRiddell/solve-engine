...
As of 2026-08-06: **97 of 122** documented examples produce the documented
answer, 10 do not, 15 differ only in formatting.
...
|---|---|---|---|
| Timespans | 1 | `12.5 minutes in minutes and seconds` | A multi-unit output format. Laptime arithmetic works and is recorded as a formatting difference. |
